...
Statistical Inference, Experimental Design, Survival Analysis, Multivariate Statistics, Multi-Level & Mixed Modeling, Stochastic Processes, Generalized Linear Models, Data Visualization


**Data Science**:

Supervised Learning, Unsupervised Learning, Train/Test Splits, K-fold Cross Validation, Sampling Techniques, Feature Engineering, Data Wrangling

**Programming Languages / Tools:**

`R`, `Python`, `SQL`, `SAS`, `Java`, `Scala`, `Bash`, `Git`, `Excel`

**Libraries:**

`Quarto`, `tidyverse`, `tidymodels`, `ggplot`, `Jupyter`, `pandas`, `numpy`, `sklearn`, `plotly`, `polars`

**Soft Skills:**

Strong Communicator, Data Storyteller, Quick Learner, Adaptable
...
* Developed an algorithm by which radar input parameters can be tuned to select optimal values according to GPS, leading to increased radar accuracy and decreased setup cost.
...
* Built analysis datasets in SQL using real-world claims data (RWD), strengthening clinical evidence used to demonstrate device effectiveness
...
## [Projects](../portfolio/index.qmd)

### [Thesis](../portfolio/thesis/index.qmd)
...
### [European Football Leagues Player Profiles Project](../portfolio/efl_proj/index.qmd)
